...
<div class="flex justify-center p-5">
	<div id="home" class="content">
		...
		<p>
			...
			this is a mistake for which there are no excuses. <br />
			<br />
		...
		<div id="goals">
			<div class="goal">
				<img
					src="https://img.icons8.com/clouds/100/000000/security-lock-yellow.png"
					alt="security" />
				<h2>Security</h2>
				<span>
			...
			<div class="goal">
				...
				<h2>Full Control</h2>
				<span>
					Users should have control over their data <b>at any time</b>
					. Not only which data they provide, but also who can access it.
				</span>
			</div>
			<div class="goal">
